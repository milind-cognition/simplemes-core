                ...
                <div class="flex justify-content-between">
                  ...
                  <IconField>
                    ...
                    <InputText v-model="requestParams.filter" :placeholder="$t('label.search')" @change="searchChanged"
                               ref="filter"/>
                    <InputIcon class="pi pi-times" @click="clearFilter" style="cursor: pointer" />
                  </IconField>
                </div>
              </template>
...
export default {
  name: 'CrudTable',
  components: {
    StandardHeader, DataTable, Column, InputText, IconField, InputIcon, Button, CrudDialog, Menu, Dialog
  },
  props: {
    columns: Array,
    service: Object,
